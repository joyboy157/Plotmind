...
## 4. Submission Method
We are using **AJAX (fetch)** to submit the form.
- This allows us to stay on the same page and show a "Success" toast.
- We send `FormData` directly to support file uploads.
